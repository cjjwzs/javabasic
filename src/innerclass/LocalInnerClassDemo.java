...
public class LocalInnerClassDemo {
    ...
    public static String address = "HangZhou";

    private int age = 22;

    private int lastage = 22;
    ...
    public void testMethod(int methodParam) {
        ...
        class MyLocalInner {
            public void show() {
                ...
                System.out.println(localInnerClassDemo.address);
                System.out.println(localInnerClassDemo.age);
                System.out.println(localInnerClassDemo.lastage);
